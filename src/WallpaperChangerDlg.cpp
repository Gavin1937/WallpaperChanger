...
// WallpaperChangerDlg.cpp : implementation file
//
...
CWallpaperChangerDlg::CWallpaperChangerDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(CWallpaperChangerDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CWallpaperChangerDlg message handlers
...
void CWallpaperChangerDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CWallpaperChangerDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CWallpaperChangerDlg::OnQueryDragIcon()
{
